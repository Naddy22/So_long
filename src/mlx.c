...
// message ou autre en fonction de ce qu'il se passe (pas tous les collectable
//quand on
...
// remettre les données du player à jours et rajouter un mouvement fait puis
//l'imprimer
...
{
	check_last_position(data, h, w, img);
	data->game.map[h][w] = '0';
	data->game.collected++;
}
